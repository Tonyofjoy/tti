...
export const metadata: Metadata = {
  title: "Cookie Policy | Tony Tech Insights",
  description: "Cookie Policy for Tony Tech Insights - Learn how we use cookies and similar technologies on our website.",
};
  ...
  return (
    <div className="container mx-auto py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <Heading level={1} className="mb-8">Cookie Policy</Heading>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-10">
            ...
            <p>
              This Cookie Policy explains how Tony Tech Insights ("we", "us", or "our") uses cookies and similar technologies 
          ...
          <section className="mb-10">
            <Heading level={2} className="mb-4">What Are Cookies?</Heading>
            <p>
            ...
            <p className="mt-4">
              Cookies set by the website owner (in this case, Tony Tech Insights) are called "first-party cookies". 
          ...
          <section className="mb-10">
            <Heading level={2} className="mb-4">Why Do We Use Cookies?</Heading>
            <p>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li>
                <strong>Performance and Functionality Cookies:</strong> These cookies are used to enhance the performance and functionality of our website 
                but are non-essential to their use. However, without these cookies, certain functionality may become unavailable.
              </li>
              <li>
                <strong>Analytics and Customization Cookies:</strong> These cookies collect information that is used either in aggregate form to help us 
              ...
              <li>
                <strong>Advertising Cookies:</strong> These cookies are used to make advertising messages more relevant to you. They perform functions like 
                preventing the same ad from continuously reappearing, ensuring that ads are properly displayed, and in some cases selecting advertisements 
          ...
          <section className="mb-10">
            <Heading level={2} className="mb-4">How Can You Control Cookies?</Heading>
            <p>
              ...
              opt-out links provided in the cookie banner on our website.
            </p>
            <p className="mt-4">
              You can also set or amend your web browser controls to accept or refuse cookies. If you choose to reject cookies, you may still use our website 
          ...
          <section className="mb-10">
            <Heading level={2} className="mb-4">How Often Will We Update This Cookie Policy?</Heading>
            <p>
              ...
              legal, or regulatory reasons. Please therefore revisit this Cookie Policy regularly to stay informed about our use of cookies and related technologies.
            </p>
            <p className="mt-4">

...
import { basicPricingItems, basicCategoryColors } from '@/data/basic-pricing'
import { Input } from '@/components/ui/input'
import { Button } from '@/components/ui/button'

export default function BasicWebBuilderQuotePage() {
  ...
  useEffect(() => {
    ...
    basicPricingItems.forEach(item => {
  ...
  const calculateTotal = () => {
    ...
    Object.entries(formData.selectedItems).forEach(([itemId, selection]) => {
      if (selection.enabled) {
        const item = basicPricingItems.find(p => p.id === itemId)
        if (item) {
      ...
      <div className="relative container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-white/70 max-w-3xl mx-auto mb-2 sm:mb-3 px-4">
            Affordable web solutions for small businesses and startups. We'll build your dream website based on your design.
          </p>
          <p className="text-xs sm:text-sm text-white/50 max-w-3xl mx-auto px-4">
            Last updated: 1/1/2025 • Basic package pricing
          </p>
        </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="$1,500 - $3,000" className="bg-black text-white">$1,500 - $3,000</option>
                      <option value="$3,000 - $5,000" className="bg-black text-white">$3,000 - $5,000</option>
                      <option value="$5,000 - $10,000" className="bg-black text-white">$5,000 - $10,000</option>
                      <option value="$10,000+" className="bg-black text-white">$10,000+</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Describe your website needs, target audience, and any specific requirements..."
                    />
                  </div>
                </form>
              </div>
            ...
            <div className="bg-gradient-to-r p-[1px] from-[#0021a7] to-[#00b8ff] rounded-2xl">
              <div className="bg-black/80 backdrop-blur-xl rounded-2xl p-4 sm:p-6">
                ...
                <div className="space-y-4 max-h-[800px] overflow-y-auto scrollbar-none">
                  {Object.entries(
                    basicPricingItems.reduce((acc, item) => {
                      if (!acc[item.category]) acc[item.category] = []
                      acc[item.category].push(item)
                      return acc
                    }, {} as Record<string, typeof basicPricingItems>)
                  ).map(([category, items]) => (
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    ...
                    <ol className="space-y-2 sm:space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-white/80 text-sm">We'll review your basic requirements within 24 hours</span>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-white/80 text-sm">Our team will contact you to discuss your project</span>
                      </li>
                      <li className="flex items-start gap-3">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 mt-1">50% upfront payment, 50% upon project completion</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 mt-1">~1–3 weeks from start date</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 mt-1">Up to 1 round included per deliverable</p>
                    </div>
                  </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 mt-1">30 days basic support after project completion</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <span className="font-semibold text-white text-lg">Additional Services:</span>
                      <p className="text-white/80 mt-1">Extended support, custom integrations available separately</p>
                    </div>
                  </div>
                </div>
              </div>
